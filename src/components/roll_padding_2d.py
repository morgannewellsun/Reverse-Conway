...
class RollPadding2D(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self._left_size_arg = batch_size_arg + [input_shape[-3], self._padding] + [1]
        self._right_begin_arg = batch_begin_arg + [0, input_shape[-2] - self._padding] + [0]
        self._right_size_arg = batch_size_arg + [input_shape[-3], self._padding] + [1]
        # y dimension
        self._top_begin_arg = batch_begin_arg + [0, 0] + [0]
        self._top_size_arg = batch_size_arg + [self._padding, input_shape[-2] + 2 * self._padding] + [1]
        self._bottom_begin_arg = batch_begin_arg + [input_shape[-3] - self._padding, 0] + [0]
        self._bottom_size_arg = batch_size_arg + [self._padding, input_shape[-2] + 2 * self._padding] + [1]
